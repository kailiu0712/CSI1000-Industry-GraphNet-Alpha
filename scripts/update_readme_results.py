...
ROWS = [
    ...
    ("Long-short cumulative — gross", "ls_cumulative_return", "{:.1%}"),
    ("Long-short cumulative — net", "ls_cumulative_return_net", "{:.1%}"),
    ("Long-only cumulative — net", "long_only_cumulative_return_net", "{:.1%}"),
